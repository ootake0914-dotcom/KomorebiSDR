...
STRINGS = {
    "ja": {
        ...
        "seek_prev": "◀ 前の局",
        "seek_next": "次の局 ▶",
        "welcome_scan_fm": "FM放送を自動スキャン (現在地の局を自動登録)",
        "welcome_scan_sw": "短波/AM放送を自動スキャン (海外・広域放送)",
        ...
        "gain_locked_msg": "ゲインを {db}dB に固定（決め打ち）しました",
    ...
    "en": {
        ...
        "seek_prev": "◀ Prev",
        "seek_next": "Next ▶",
        "welcome_scan_fm": "Scan FM Stations (Auto-detect Local Broadcasts)",
        "welcome_scan_sw": "Scan Shortwave / AM (International & DX)",
